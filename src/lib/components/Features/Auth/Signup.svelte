...
<div class="auth-container">
  ...
  <div class="hero-section" transition:fade={{ duration: 300 }}>
    <div class="hero-content">
      <h1>Your Garden's New Best Friend</h1>
      <p>Experience Next-Level Indoor Farming with Advanced Automation and Monitoring and Unlock the Full Potential of Indoor Farming with Smart IoT Automation</p>
  ...
  <div class="form-section" transition:fade={{ duration: 300 }}>
    ...
    <div class="form-container">
      ...
      <form on:submit={handleSignup}>
        ...
        <button type="button" class="btn-google" on:click={handleGoogleSignup}>
